...
(function () {
    ...
    function ThreewoodBatchNewsViewController($scope, $routeParams, $http, notificationsService, ThreewoodBatchfileUploadService) {
    ...
    angular.module("umbraco").controller("Threewood.Batch.News.ViewController", ThreewoodBatchNewsViewController);
})();